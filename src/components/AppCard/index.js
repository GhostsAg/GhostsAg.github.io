    ...
    return (
        <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
                <img className="activator" alt="profile" src={props.img} />
            </div>
            <div className="card-content">
                ...
                <p><a href={props.link} target="_blank" rel="noopener noreferrer">Open App</a></p>
            </div>
            <div className="card-reveal">
                ...
                <p><a href={props.repo} target="_blank" rel="noopener noreferrer">Repo</a></p>
            </div>
        </div>
    );
}
